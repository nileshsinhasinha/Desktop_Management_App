...
Folder_mapping = {
    'Codes': ['.C', '.cc', '.cxx', '.cpp', '.c++', '.asp', '.aspx', '.axd', '.asx', '.asmx', '.ashx', '.cfm', '.yaws',
              '.htm', '.html', '.xhtml', '.shtml', '.jhtml', '.jsp', '.jspx', '.wss', '.do', '.action', '.pl', '.php',
              '.php4', '.php3', '.phtml', '.py', '.rb', '.rhtml', '.rss', '.xml', '.cgi', '.dll', '.fcgi'],
    'Music': ['.3gp', '.aa', '.aac', '.aax', '.act', '.aiff', '.amr', '.ape', '.au', '.awb', '.dct', '.dss', '.dvf',
              '.flac', '.gsm', '.iklax', '.ivs', '.m4a', '.m4b', '.m4p', '.mmf', '.mp3', '.mpc', '.msv', '.ogg', '.oga',
              '.mogg', '.opus', '.ra, .rm', '.raw', '.sln', '.tta', '.vox', '.wav', '.wma', '.wv', '.webm', '.8svx'],
    'Video': ['.yuv', '.wmv', '.webm', '.vob', '.svi', '.roq', '.rmvb', '.rm', '.ogv', '.ogg', '.nsv', '.mxf', '.mpg',
              '.mpeg', '.m2v', '.mpg', '.mp2', '.mpeg', '.mpe', '.mpv', '.mp4', '.m4p', '.m4v', '.mov', '.qt', '.mng',
              '.mkv', '.m4v', '.gifv', '.gif', '.flv', '.f4v', '.f4p', '.f4a', '.f4b', '.flv', '.flv', '.drc', '.avi',
              '.asf', '.amv', '.3gp', '.3g2'],
    'Image': ['.tif', '.tiff', '.gif', '.jpeg', 'jpg', '.jif', '.jfif', '.jp2', '.jpx', '.j2k', '.j2c', '.fpx', '.pcd',
              '.png'],
